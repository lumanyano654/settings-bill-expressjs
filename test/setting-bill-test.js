...
describe('settings-bill', function(){
    ...
    it('should calculate the right totals', function(){
        ...
        assert.equal(2.35, settingsBill.totals().totalSmsCost);
        assert.equal(3.35, settingsBill.totals().totalCallCost);
    ...
    it('should calculate the right totals for multiple actions', function(){
        ...
        assert.equal(4.70, settingsBill.totals().totalSmsCost);
        assert.equal(6.70, settingsBill.totals().totalCallCost);
    ...
    it('should know when critical level reached', function(){
        ...
        assert.equal(true, settingsBill.hasReachedCriticalLevel2());
